...
import PaymentsTableFilter from '@/components/Lender/LenderTotalDealPayments/PaymentsTableFilter.vue';
  ...
  computed: {
    ...
    filteredDealList() {
      ...
      tmp.forEach((e) => {
        ...
        this.currencyType = e.deal_currency;
      ...
      return [
        ...tmp,
        {
          Date: 'TOTAL',
          'Deal Value':
            this.currencyType + numeral(tmp_totalValue).format('0,0.[00]'),
          Outstanding:
            this.currencyType +
            numeral(tmp_totalOutstanding).format('0,0.[00]'),
          Payment:
            this.currencyType + numeral(tmp_totalPayments).format('0,0.[00]'),
