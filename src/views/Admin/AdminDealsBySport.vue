<template>
  <div class="content">
    <HeaderNavigation>Deals by Sport</HeaderNavigation>
    <v-row no-gutters>
      <v-col cols="12" lg="8">
...
import AdminDealsBySportFilters from '../../components/AdminDashboard/AdminDealsBySportFilters/index.vue';
