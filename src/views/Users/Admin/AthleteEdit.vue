<template>
  <div class="content">
    ...
    <div class="grid">
      <AthletesList
        @editAthlete="getUserInfo"
        class="component-no-padding athlete-list"
      />
      ...
      <div class="component endorsment-deals">
        ...
        <div class="deals">
          ...
          />
          <p v-if="sponsorships.length == 0">There are no deals.</p>
        </div>
      </div>

      <simple-modal v-model="isShow" title="Choose endorswment deal">
        <template slot="body">
          <AddSponsor
...
import AthletesList from '@/components/AdminUserProfile/AthletesList';
...
@media only screen and (min-width: 1294px) {
  .grid.grid {
    ...
    grid-template-areas:
      'athlete-list user-info documents  '
      'athlete-list user-info endorsment-deals  '
      'athlete-list user-info social-media '
...
@media only screen and (max-width: 1293px) {
  .grid.grid {
    ...
    grid-template-areas:
      'athlete-list user-info'
      'documents user-info'
      'endorsment-deals user-info  '
