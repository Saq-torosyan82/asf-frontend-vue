<template>
  <div class="content">
    ...
    <HeaderNavigation>Financial Manager profile</HeaderNavigation>
    <div class="grid">
      <FinancialManagersList
...
import FinancialManagersList from "@/components/AdminUserProfile/FinancialManagersList";
...
export default {
  name: 'FinancialManagerAdminEdit',
  components: {
    NotificationMessage,
    HeaderNavigation,
    Footer,
