<template>
  <div>
    <div class="user-information add-brand">
      ...
      <a href="#" class="button" @click.prevent="saveBrand()">Save</a>
    </div>
  </div>
</template>
  ...
  methods: {
    saveBrand() {
      ...
      if (!this.$v.form.$invalid) {
        ...
        SystemRepository.createBrand(data).then((response) => {
