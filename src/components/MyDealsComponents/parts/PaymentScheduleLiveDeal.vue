      ...
      <template>
        ...
        <tfoot>
          <tr class="footer">
            ...
            <td>{{ currency }} {{ grossAmount | numFormat('0,0.[00]') }}</td>
            <td colspan="1">
          ...
          <tr class="">
            <td colspan="4">Legal Costs</td>
            <td colspan="1">
              {{ currency }} {{ legalCost.toFixed(3) | numFormat('0,0.[00]') }}
            </td>
          </tr>
          <tr class="">
            <td colspan="4">Insurance expense</td>
            <td colspan="1">{{ currency }} 0</td>
          </tr>
          <tr class="">
          ...
          <tr class="footer separator-top">
            ...
            <td colspan="1">
              ...
              {{
                (totalPaymentAmount -
                  legalCost -
                  getFeesAmount(feesTotalAndInsurance))
                  | numFormat('0,0.[00]')
              }}
            </td>
          </tr>
